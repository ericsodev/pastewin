  ...
  return (
    <div className="flex grow items-center justify-center">
      <div className="md:1/2 relative flex w-2/3 flex-col justify-center gap-4 lg:w-1/3">
        ...
        <h1 className="m-0 w-max text-center text-6xl font-bold text-slate-700 dark:text-violet-50 dark:drop-shadow-[0_35px_35px_rgba(179,118,219,0.25)] md:text-6xl lg:text-6xl xl:text-7xl">
          share your{" "}
